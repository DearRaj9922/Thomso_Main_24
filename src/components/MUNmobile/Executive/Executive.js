...
import judge1 from "../../../assets/hero1.webp";
import judge2 from '../../../assets/hero1.webp'
import judge3 from '../../../assets/hero1.webp';
  ...
  const slides = [
    {
      ...
      content: <div className="judge1div">
        ...
        <div className='judge1-discription'>TO BE DECLARED</div>

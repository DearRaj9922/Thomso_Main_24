	...
	return (
		<>
			...
			<div className='home_wrapper'>
				...
				{/* Navbar */}
				<Navbar fontcolor='black' bright='brightness(0)' />
				...
				<div className='sec2'>
					...
					<div className='about'>
						...
						<p>
							The theme of Thomso’24 is ‘A Crossroad of Cultures’, which means a
							place or state of perfect happiness derived from a broad and
							diverse range of sources. This theme reflects the vision and
							mission of Thomso’24, which is to celebrate the diversity and
							richness of human expression and culture. Thomso’24 aims to
							provide a mesmerizing experience that will fuse the mystical charm
							of the universe with the vitality of human expression. Thomso’24
							invites you to escape from the dullness of your daily life and
							dive into a world full of wonder and fascination, where every
							moment is a new adventure waiting to happen.
						</p>
					</div>
				</div>
				{/* Train */}

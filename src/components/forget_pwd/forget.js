...
import "./forget.css";
import welcomebckbg from "../../assets/regbg.webp";
import axios from "axios";
import SimpleReactValidator from "simple-react-validator";
import { message } from "antd";
import logo from "../../assets/logowhite.svg";
import mobilewp from "../../assets/regbgmob.webp";
...
const Forget = () => {
  ...
  async function handleSendEmail(e) {
    ...
    if (validator.allValid()) {
      const response = await axios.post("https://api2.thomso.in/apiV1/resetpassword", {
        email: email,
      });
